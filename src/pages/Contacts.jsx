    ...
    <>
      <main className="h-[40rem]">
        <div className="flex justify-center ">
          <h1 className="text-white text-5xl w-11/12 text-center pt-10">
            Contate-nos
          </h1>
        </div>
          ...
          <form action="" onSubmit={sendEmail} className="flex flex-col w-7/12">
            ...
            <div className="flex justify-center mt-3">
              <button
                type="submit"
                value="enviar"
                className="px-7 py-4 bg-gradient-to-r from-[#6100FF] to-[#00BA61] dark:bg-dmnav text-white font-semibold rounded-full focus:outline-none text-3xl"
              >
                Enviar
              </button>
            </div>
            ...
            <p className="text-center text-white text-2xl mt-8">
              Se precisar de ajuda, parceria ou tiver sugestões, envie sua
              mensagem aqui.
            </p>
          </form>
        </div>
